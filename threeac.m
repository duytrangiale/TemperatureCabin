...
T1(25,:,1:10)=T0;T1(:,17,1:7.5)=T0; %%车表面温度

T1(5:25,:,15)=T_top; %车顶温度

T1(a:a+2,b:b+4,2:9)=37; % A man 
T1(5:6,5:13,9:10) = T_ac;
T1(15:16,8:10,6:7) = T_ac; % The dimension of heater
T1(5,:,10:15) = T0;
T1(25,:,10:15) = T0;
T1(5:25,1,10:15) = T0;
T1(5:25,17,10:15) = T0;% Glass
...
k(5:6,5:13,9:10) = k3;k(15:16,8:10,6:7) = k3; %heater
...
T2(25,:,1:10)=T0;T2(:,17,1:7.5)=T0; %%surface temp

T2(5:25,:,15)=T_top; %the floor temperature

T2(a:a+2,b:b+4,2:9)=37; % A man 
T2(5:6,5:13,9:10) = T_ac; T2(15:16,8:10,6:7) = T_ac;% The dimension of heater
T2(5,:,10:15) = T0;
T2(25,:,10:15) = T0;
T2(5:25,1,10:15) = T0;
T2(5:25,17,10:15) = T0;% 车玻璃温度
T2(1:4,:,11:15)=T0;
